...
DELETE from CATEGORY WHERE CATEGORY_NAME = 'fghfgh';
...
CREATE TABLE EMPLOYEE_LOGIN (
	...
	EMP_ROLE ENUM('ADMIN', 'COUNTER')
);
insert into EMPLOYEE_LOGIN VALUES ('E002','RENU','COUNTER');
CREATE TABLE ORDERS (
...
PRIMARY KEY (EMP_ID, EMP_MOBILE),FOREIGN KEY (EMP_ID) REFERENCES EMPLOYEE(EMP_ID)
);
